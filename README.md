...
**Current version: [5.16.22-velvet](releases/v5.16.22-velvet.md)** — March 2026
...
<p align="center">
  <a href="docs/front.jpg"><img src="docs/front.jpg" alt="Player UI" width="480" /></a>
  &nbsp;&nbsp;
  <a href="docs/admin.jpg"><img src="docs/admin.jpg" alt="Admin UI" width="480" /></a>
</p>
...
- **Butterchurn / Milkdrop visualizer** — Full-screen, preset cycling
...
- Scan error log with type filter, retention setting, and clear button
