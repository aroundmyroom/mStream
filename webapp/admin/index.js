        ...
        <div class="col s12">
          <div class="card">
            <div class="card-content">
              ...
              <p style="margin:0 0 1.25rem;color:var(--t2);font-size:.85rem;">mStream Developed by <strong style="color:var(--t1);">Paul Sori</strong><br><span style="font-weight:300;color:var(--t2);">m</span><span style="font-weight:700;color:var(--t1);">Stream</span> <span style="font-size:9px;font-weight:600;letter-spacing:.22em;text-transform:uppercase;color:var(--primary);opacity:.85;vertical-align:middle;position:relative;top:-1px;">Velvet</span> v{{version.val}} — a fork of mStream<br>Features, Functionality and Maintenance by <strong style="color:var(--t1);">Dennis Slagers</strong> (AroundMyRoom)</p>
